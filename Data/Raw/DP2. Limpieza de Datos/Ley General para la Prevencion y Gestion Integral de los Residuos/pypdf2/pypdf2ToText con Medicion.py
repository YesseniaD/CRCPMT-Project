...
file_path = '.\Ley General para la Prevencion y Gestion Integral de los Residuos.pdf'
pdf = PdfFileReader(file_path)

with open('Ley General para la Prevencion y Gestion Integral de los Residuos.txt', 'w') as f:
...
filename = "Ley General para la Prevencion y Gestion Integral de los Residuos.txt"
try:
