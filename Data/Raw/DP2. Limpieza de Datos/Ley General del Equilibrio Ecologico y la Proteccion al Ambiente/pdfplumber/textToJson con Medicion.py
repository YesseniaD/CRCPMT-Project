...
filename = 'Ley General del Equilibrio Ecologico y la Proteccion al Ambiente.txt'
...
out_file = open("Ley General del Equilibrio Ecologico y la Proteccion al Ambiente.json", "w")
